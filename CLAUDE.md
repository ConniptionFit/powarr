...
| Field | Value |
|---|---|
| Version | v0.31.0 — altTitles in LLM ctx, release junk stripper, year hard-fail, pack chunking, small→classified, deletion factor summary; v0.30.0 cleanup scoring + LLM scaffold |
