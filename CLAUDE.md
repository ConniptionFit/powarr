...
| Field | Value |
|---|---|
| Version | v0.34.0 — Lidarr album match, deps health, breakers, request IDs, Fernet secrets, Smart Playlists; v0.33.0 tray coalesce; v0.32.0 per-*arr LLM + partial gap-fill |
