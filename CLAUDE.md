...
| Field | Value |
|---|---|
| Version | v0.28.0 pushed to `origin` + `github` (`5ccad6e`, 2026-07-09) — **container rebuild + container test suite + live verify pending**; live container may still be v0.26.0 |
