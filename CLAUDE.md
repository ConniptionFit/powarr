...
| Field | Value |
|---|---|
| Version | v0.35.2 — Qdrant integration UI + feature roadmap, type fixes; v0.35.1 Smart Playlists scheduler/auto-add redesign, security hardening |
...
| Qdrant / Music Discovery | Vector DB integration for semantic search & recommendations | `integrations/qdrant.py`, `api/v1/playlists.py` (test endpoint); [[Smart Playlists]]. v0.35.2: UI card on Integrations page, test connection + collection stats, metadata exploration. Foundation for v0.36+ mood/era filtering, similarity search, discovery recommendations. [[Qdrant features roadmap]]. |
