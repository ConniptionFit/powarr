...
| Field | Value |
|---|---|
| Version | v0.35.1 — classic Failed Imports filters restored (v0.35.0 filter redesign reverted; still_in_queue API kept); v0.34.0 Lidarr albums / deps / Smart Playlists |
