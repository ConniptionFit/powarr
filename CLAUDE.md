...
| Field | Value |
|---|---|
| Version | v0.28.2 — Servarr NullReference 500 → folder-only manualimport fallback + orphan; gone-at-accept (v0.28.1) |
