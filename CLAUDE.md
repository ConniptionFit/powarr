...
| Field | Value |
|---|---|
| Version | v0.33.0 — coalesced/stacked Active Processes tray + per-item Pushing; v0.32.0 per-*arr LLM + Lidarr edition strip + partial gap-fill; v0.31.0 altTitles/junk/year/pack chunks |
